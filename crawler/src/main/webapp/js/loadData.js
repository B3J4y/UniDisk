...
var domain = "rest/crawler/start"
//var domain = "http://localhost:8084/crawler/start"
//var backendUrl = "php/handleDb.php";
var backendurl = "rest/legacy/handledb";

var active = "";
var firstTime = 0;
var campaigns = {};
var props = {}; // are set in unidisk.json
var processIcons = [
	"glyphicon-leaf",
	"glyphicon-plane",
	"glyphicon-ok",
...
// set props based on unidisk.json
...
function loadCampaign(element) {
	...
	if ($(element).find("#scoreStich")[0].innerHTML == "0" ) {
		...
		$("#resTables").show();
		$("#mapTab").show();
		displayData(0, backendurl, $(element).attr("id"));
	}
