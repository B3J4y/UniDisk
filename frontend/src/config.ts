...
const LOCAL_DOCKER_ENDPOINT = 'http://stud-01.cs.uni-potsdam.de:80/api/unidisk/rest/';
//IntelliJ
...
export const KEYWORD_SERVICE_ENDPOINT =
  process.env.RECOMMENDATION_ENDPOINT ?? 'http://stud-01.cs.uni-potsdam.de:80/recommendation';
